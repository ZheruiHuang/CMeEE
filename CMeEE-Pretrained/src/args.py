...
class ModelConstructArgs(_Args):
    ...
    optimizer: Optional[bool] = field(default=False, metadata={"help": "Whether to use optimizer"})
...
class CBLUEDataArgs(_Args):
    ...
    synonyms_replacement: bool = field(default=False, metadata={"help": "Whether to replace words with synonyms in training data"})
